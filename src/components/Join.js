                ...
                <div>
                    <main className="relative top-16 mb-20">
                        <div className="flex flex-col justify-center items-center h-screen gap-5">
                            ...
                            <button
                                type="button"
                                className="bg-black text-white px-8 py-3 rounded-full font-semibold text-xl hover:bg-gray-800 transition duration-300 mt-8"
                                onClick={() => setShowForm(true)}
                            >
                                Join Us
                            </button>
                            <div className="w-full max-w-md grid gap-5 mt-8">
